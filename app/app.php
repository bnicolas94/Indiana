				...
				<div class="tabla1">
					...
					<tr>
						...
						<th>
							...
							<img src="images/ok.png" data="<?php echo $rows['cod']; ?>" width="50px" class="confirmar" alt=""> 
							
							<?php }else{echo 'Confirmado';} ?>

						</th>
						<th>
							<img src="images/no.png" data="<?php echo $rows['cod']; ?>" class="eliminar" width="30px" alt="">
			...
			<div class="col s12"><!-- LISTA INDIVIDUAL -->
				<div class="tabla2" style="display: none;">
					...
					<tr>
						...
						<img src="images/ok.png" style="display: none;" class="confirmar" id="img-ok" width="30px" data="" alt="">
								

						</th>
						<th id="delete" class="">
							<img src="images/no.png" class="eliminar" id="img-no" width="30px" data=""  alt="">
